...
export const DonatePage: React.FC = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="mb-8">
        <h1 className="text-2xl font-extrabold tracking-tight text-text">Support Documentr</h1>
      ...
      <Surface className="p-6 mb-5">
        ...
        <p className="text-xs mb-5 text-text2">Documentr stays free, open source, and self-hosted.</p>
      ...
      <Surface className="p-6">
        ...
        <p className="text-xs text-text2">Every bit of support helps keep Documentr available for everyone.</p>
      </Surface>
    </div>
  );
};
